            ...
            <div className="bg-white dark:bg-[#151c2c] border-b border-gray-100 dark:border-gray-800">
                <div className="max-w-7xl mx-auto px-6 py-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mt-2">
                        Moderate listings, manage users, and view analytics
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 max-w-sm mx-auto">
                        The Admin Dashboard is coming in Phase 5. You'll manage moderation, seller verification, and platform analytics here.
                    </p>
                </div>
            </div>
        </div>

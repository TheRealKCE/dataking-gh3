            ...
            <div className="flex-1">
                <div className="bg-white dark:bg-[#151c2c] border-b border-gray-100 dark:border-gray-800">
                    <div className="max-w-6xl mx-auto px-6 py-8">
                        <h1 className="text-3xl font-black text-gray-900 dark:text-white">Reports & Analytics</h1>
                        <p className="text-gray-600 dark:text-gray-400 mt-2">View platform analytics and insights</p>
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto px-6 py-12">
                    <div className="bg-white dark:bg-[#151c2c] rounded-xl border border-gray-100 dark:border-gray-800 p-12 text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-6">
                            Analytics and reporting will be available in Phase 5.
                        </p>

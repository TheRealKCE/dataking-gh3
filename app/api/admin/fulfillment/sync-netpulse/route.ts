...
//   NetPulse → failed/cancelled : update order to failed (admin does manual refund)
                ...
                try {
                    ...
                    if (newStatus === 'completed') {
                        ...
                        if (updateError) {
                            ...
                            console.log(`[NetPulseSync] shop_orders ${order.id}: processing → completed`)
                            updated++
                        }
                        ...
                        if (updateError) {
                            ...
                            console.log(`[NetPulseSync] shop_orders ${order.id}: processing → failed (manual refund required)`)
                            updated++
                        }
                    }
                } catch (err: any) {
                ...
                try {
                    ...
                    if (newStatus === 'completed') {
                        ...
                        if (updateError) {
                            ...
                            console.log(`[NetPulseSync] orders ${order.id}: processing → completed`)
                            updated++
                        }
                    } else if (newStatus === 'failed') {
                        const { error: updateError } = await db
                        ...
                        if (updateError) {
                            ...
                            console.log(`[NetPulseSync] orders ${order.id}: processing → failed (manual refund required)`)
                            updated++
                        }
                    }
                } catch (err: any) {

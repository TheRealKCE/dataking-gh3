    ...
    if (success) {
        return (
            <div className="min-h-screen w-full flex flex-col items-center justify-center px-3 py-6 sm:p-4 overflow-y-auto">
                ...
                <Card className="w-full max-w-[340px] sm:max-w-sm border-0 bg-[#E5E7EB]/60 backdrop-blur-md relative z-10 shadow-xl rounded-xl">
                    <CardContent className="pt-6 text-center p-5">
                        ...
                        <Link href="/auth/login">
                            <Button className="w-full h-10 text-sm font-bold bg-[#0056B3] hover:bg-[#004494] text-white shadow-md rounded-lg">
                                Go to Login
                            </Button>
                        </Link>
                    </CardContent>
            ...
            <div className="w-full max-w-[340px] sm:max-w-sm relative z-10 flex flex-col items-center">
                ...
                <div className="text-center mb-3">
                    <Link href="/" className="inline-flex flex-col items-center">
                        <div className="relative w-14 h-14 sm:w-16 sm:h-16 mb-1.5">
                ...
                <Card className="w-full border-0 bg-[#E5E7EB]/60 backdrop-blur-md shadow-xl rounded-xl overflow-hidden">
                    <CardContent className="p-4 sm:p-5">
                        <form onSubmit={handleSubmit} className="space-y-2.5">
                            {error && (
                                <Alert variant="destructive" className="bg-red-500/10 border-red-500/50 py-1.5">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        required
                                        className="h-9 pl-9 bg-white/90 border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-[#0056B3] focus:ring-[#0056B3]/20 rounded-lg text-sm"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-1">
                                <Label htmlFor="phoneNumber" className="text-slate-700 font-semibold text-xs">Mobile Number</Label>
                                <div className="relative">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        onChange={handleChange}
                                        required
                                        className="h-9 pl-9 pr-9 bg-white/90 border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-[#0056B3] focus:ring-[#0056B3]/20 rounded-lg text-sm"
                                    />
                                    <button
                                        type="button"
                            ...
                            <Button
                                type="submit"
                                disabled={isLoading}
                                className="w-full h-10 text-sm font-bold bg-[#0056B3] hover:bg-[#004494] text-white shadow-md rounded-lg mt-1"
                            >
                                {isLoading ? (
                                    <>

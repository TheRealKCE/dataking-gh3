...
export default function UpgradePage() {
    ...
    const benefits = [
        {
            ...
            description: 'Access discounted rates on all data packages and maximize profit margins',
        ...
        },
        {
            ...
            description: 'Priority order fulfillment with near-instant delivery',
        ...
        },
        {
            icon: Sparkles,
            title: '0% Top-Up Fees',
            description: 'Zero transaction fees when adding funds to your wallet',
        ...
        },
        {
            ...
            description: 'Track purchases and manage your client base with analytics',
        ...
        },
        {
            ...
            description: 'Exclusive premium interface with royal golden aesthetics',
        ...
        },
        {
            ...
            description: 'Direct messaging with administrators for priority support',
    ...
    <Link
        href=\"/dashboard\"
    className =\"fixed top-6 right-6 z-50 p-3 rounded-full bg-white/10 backdrop-blur-md hover:bg-white/20 transition-all duration-300 group\"
        >
...
<div className=\"relative inline-block\">
    ...
    < div className =\"space-y-4\">
        < h1 className =\"text-6xl sm:text-7xl lg:text-8xl font-black bg-gradient-to-r from-yellow-200 via-yellow-400 to-amber-500 bg-clip-text text-transparent drop-shadow-2xl\">
                            Kingdom Palace
                        </h1 >
    <p className=\"text-2xl sm:text-3xl text-gray-300 font-semibold\">
                            Ascend to Agent Status
                        </p >
    ...
    < div className =\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20\">
{
    benefits.map((benefit, index) => (
        <div
            key={index}
            className=\"group relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:border-yellow-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-2\"
            >
            {/* Glow Effect */ }
...
<div className=\"inline-flex items-center justify-center w-20 h-20 rounded-full bg-black/20 backdrop-blur-sm\">
    ...
    {/* Price */ }
    < div className =\"py-6\">
        < div className =\"text-7xl font-black text-black mb-3\">
{ formatCurrency(upgradePrice) }
                                    </div >
    <p className=\"text-black/70 text-base font-bold uppercase tracking-wide\">
One - Time Investment
                                    </p >
                                </div >
...
size =\"lg\"
className =\"w-full h-16 text-xl font-black bg-black hover:bg-gray-900 text-yellow-400 rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 active:scale-95 disabled:opacity-50 group/btn\"
    >
{
    isProcessing?(
                                        <>

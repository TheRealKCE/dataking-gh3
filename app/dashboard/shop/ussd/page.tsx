...
export default function UssdActivationPage() {
    ...
    if (!info?.hasShop) {
        return (
            <div className="space-y-6 pb-20 md:pb-6">
                <Link href="/dashboard/shop"><Button variant="ghost" className="gap-2"><ArrowLeft className="w-4 h-4" /> Back</Button></Link>
                <Card>
                    <CardContent className="py-12 text-center space-y-3">
                        ...
                        <Link href="/dashboard/shop/setup"><Button className="mt-2">Set Up Shop</Button></Link>
                    </CardContent>
                </Card>
            </div>
        )
    ...
    if (info.status === 'active' && info.shortCode) {
        return (
            <div className="space-y-6 pb-20 md:pb-6">
                <Link href="/dashboard/shop"><Button variant="ghost" className="gap-2"><ArrowLeft className="w-4 h-4" /> Back to Shop</Button></Link>
        ...
        <div className="space-y-6 pb-20 md:pb-6">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 dark:from-black dark:to-zinc-900 p-8 border border-slate-700">
                ...
                <p className="text-slate-300 mt-2 max-w-lg">
                    Get your own 4-character short code. Customers dial <span className="font-mono text-white">{info.dialCode || 'the ARHMS USSD code'}</span>,
            ...
            {!info.eligible ? (
                <Card>
                    <CardContent className="py-8 text-center space-y-2">
                        <p className="font-bold">Your shop is awaiting approval</p>
                        <p className="text-sm text-muted-foreground">Once approved, you can activate your short code here.</p>
                    </CardContent>
                </Card>
            ) : (
                <Card>
                    ...
                    <CardContent className="space-y-5">
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            >
                                ...
                                <p className="font-bold text-sm">ARHMS Wallet</p>

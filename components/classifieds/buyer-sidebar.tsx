...
const buyerNavItems = [
    { href: '/classifieds/buyer/dashboard', label: 'Favorites', icon: Heart },
    { href: '/classifieds/buyer/dashboard/purchases', label: 'Purchases', icon: ShoppingCart },
]

export function ClassifiedsBuyerSidebar() {
    ...
    return (
        <div className="w-64 bg-white dark:bg-[#151c2c] border-r border-gray-200 dark:border-gray-800 min-h-screen sticky top-0">
            <div className="p-6">
                ...
                <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Buyer Tools</h2>

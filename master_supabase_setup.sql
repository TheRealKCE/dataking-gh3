...
-- Generated from every SQL file under supabase/.
-- Safe to run repeatedly in Supabase SQL Editor: object creation is guarded with IF NOT EXISTS,
-- policies/functions/views/triggers are made repeat-safe, and seed inserts use ON CONFLICT DO NOTHING where possible.
...
ALTER TABLE public.shop_announcements ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/add_announcements_schema.sql
ALTER TABLE public.shop_announcements ADD COLUMN IF NOT EXISTS shop_id UUID REFERENCES public.shop_profiles(id) ON DELETE CASCADE;


-- Source: supabase/add_announcements_schema.sql
ALTER TABLE public.shop_announcements ADD COLUMN IF NOT EXISTS message TEXT;


-- Source: supabase/add_announcements_schema.sql
ALTER TABLE public.shop_announcements ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT true;


-- Source: supabase/add_announcements_schema.sql
ALTER TABLE public.shop_announcements ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/add_pricing_approval.sql
ALTER TABLE public.shop_pricing_pending ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/add_pricing_approval.sql
ALTER TABLE public.shop_pricing_pending ADD COLUMN IF NOT EXISTS shop_id UUID REFERENCES public.shop_profiles(id) ON DELETE CASCADE;


-- Source: supabase/add_pricing_approval.sql
ALTER TABLE public.shop_pricing_pending ADD COLUMN IF NOT EXISTS package_id UUID REFERENCES public.data_packages(id) ON DELETE CASCADE;


-- Source: supabase/add_pricing_approval.sql
ALTER TABLE public.shop_pricing_pending ADD COLUMN IF NOT EXISTS selling_price DECIMAL(12, 2);


-- Source: supabase/add_pricing_approval.sql
ALTER TABLE public.shop_pricing_pending ADD COLUMN IF NOT EXISTS submitted_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS user_id UUID REFERENCES public.users(id) ON DELETE CASCADE;


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS user_role TEXT DEFAULT 'customer';


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS beneficiary_phone TEXT;


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS network TEXT CHECK (network IN ('MTN', 'Telecel', 'AT'));


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS airtime_amount DECIMAL(12,2) CHECK (airtime_amount > 0);


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS fee_rate DECIMAL(5,2) DEFAULT 0;


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS fee_amount DECIMAL(12,2) DEFAULT 0;


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS total_paid DECIMAL(12,2) CHECK (total_paid > 0);


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS use_exact_amount BOOLEAN DEFAULT false;


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'pending' CHECK (status IN ('pending', 'processing', 'completed', 'failed'));


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS reference_code TEXT;


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS fulfillment_note TEXT;


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS fulfilled_by UUID REFERENCES public.users(id);


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS fulfilled_at TIMESTAMP WITH TIME ZONE;


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/airtime_migration.sql
ALTER TABLE public.airtime_orders ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/chat_schema.sql
ALTER TABLE public.chat_conversations ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/chat_schema.sql
ALTER TABLE public.chat_conversations ADD COLUMN IF NOT EXISTS agent_id UUID REFERENCES public.users(id) ON DELETE CASCADE;


-- Source: supabase/chat_schema.sql
ALTER TABLE public.chat_conversations ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'active' CHECK (status IN ('active', 'closed'));
...
-- Source: supabase/chat_schema.sql
ALTER TABLE public.chat_messages ADD COLUMN IF NOT EXISTS sender_id UUID REFERENCES public.users(id) ON DELETE CASCADE;
...
-- Source: supabase/migrations/20250001000000_download_batches_rls.sql
ALTER TABLE public.download_batches ADD COLUMN IF NOT EXISTS id uuid DEFAULT gen_random_uuid();


-- Source: supabase/migrations/20250001000000_download_batches_rls.sql
ALTER TABLE public.download_batches ADD COLUMN IF NOT EXISTS admin_id uuid REFERENCES public.users(id);


-- Source: supabase/migrations/20250001000000_download_batches_rls.sql
ALTER TABLE public.download_batches ADD COLUMN IF NOT EXISTS filename text;


-- Source: supabase/migrations/20250001000000_download_batches_rls.sql
ALTER TABLE public.download_batches ADD COLUMN IF NOT EXISTS order_count integer DEFAULT 0;


-- Source: supabase/migrations/20250001000000_download_batches_rls.sql
ALTER TABLE public.download_batches ADD COLUMN IF NOT EXISTS export_mode text;


-- Source: supabase/migrations/20250001000000_download_batches_rls.sql
ALTER TABLE public.download_batches ADD COLUMN IF NOT EXISTS network text;


-- Source: supabase/migrations/20250001000000_download_batches_rls.sql
ALTER TABLE public.download_batches ADD COLUMN IF NOT EXISTS idempotency_key text;


-- Source: supabase/migrations/20250001000000_download_batches_rls.sql
ALTER TABLE public.download_batches ADD COLUMN IF NOT EXISTS created_at timestamptz DEFAULT now();


-- Source: supabase/migrations/20260318_auto_update_shop_pricing.sql
ALTER TABLE public.shop_pricing_logs ADD COLUMN IF NOT EXISTS id UUID DEFAULT gen_random_uuid();


-- Source: supabase/migrations/20260318_auto_update_shop_pricing.sql
ALTER TABLE public.shop_pricing_logs ADD COLUMN IF NOT EXISTS shop_id UUID REFERENCES public.shop_profiles(id) ON DELETE CASCADE;


-- Source: supabase/migrations/20260318_auto_update_shop_pricing.sql
ALTER TABLE public.shop_pricing_logs ADD COLUMN IF NOT EXISTS package_id UUID REFERENCES public.data_packages(id) ON DELETE CASCADE;


-- Source: supabase/migrations/20260318_auto_update_shop_pricing.sql
ALTER TABLE public.shop_pricing_logs ADD COLUMN IF NOT EXISTS old_cost_price DECIMAL(12,2);


-- Source: supabase/migrations/20260318_auto_update_shop_pricing.sql
ALTER TABLE public.shop_pricing_logs ADD COLUMN IF NOT EXISTS new_cost_price DECIMAL(12,2);


-- Source: supabase/migrations/20260318_auto_update_shop_pricing.sql
ALTER TABLE public.shop_pricing_logs ADD COLUMN IF NOT EXISTS old_selling_price DECIMAL(12,2);


-- Source: supabase/migrations/20260318_auto_update_shop_pricing.sql
ALTER TABLE public.shop_pricing_logs ADD COLUMN IF NOT EXISTS new_selling_price DECIMAL(12,2);


-- Source: supabase/migrations/20260318_auto_update_shop_pricing.sql
ALTER TABLE public.shop_pricing_logs ADD COLUMN IF NOT EXISTS changed_at TIMESTAMPTZ DEFAULT NOW();


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_types ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_types ADD COLUMN IF NOT EXISTS name TEXT;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_types ADD COLUMN IF NOT EXISTS agent_price DECIMAL(12,2);


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_types ADD COLUMN IF NOT EXISTS cost_price DECIMAL(12,2);


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_types ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_types ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS type_id UUID REFERENCES public.results_checker_types(id) ON DELETE CASCADE;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS pin TEXT;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS serial_number TEXT;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'available'
                            CHECK (status IN ('available', 'reserved', 'sold'));


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS reserved_by_order UUID;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS reservation_expires_at TIMESTAMPTZ;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS sold_to_user_id UUID REFERENCES public.users(id) ON DELETE SET NULL;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS sold_at TIMESTAMPTZ;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS batch_id TEXT;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS expiry_date DATE;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_inventory ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS user_id UUID REFERENCES public.users(id) ON DELETE SET NULL;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS shop_id UUID REFERENCES public.shop_profiles(id) ON DELETE SET NULL;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS shop_markup DECIMAL(12,2) DEFAULT 0;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS customer_name TEXT;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS customer_email TEXT;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS customer_phone TEXT;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS type_id UUID REFERENCES public.results_checker_types(id);


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS type_name TEXT;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS unit_price DECIMAL(12,2);


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS merchant_commission DECIMAL(12,2) DEFAULT 0;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS inventory_ids UUID[];


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS payment_status TEXT DEFAULT 'pending'
                          CHECK (payment_status IN ('pending', 'pending_payment', 'completed', 'failed'));


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS reference_code TEXT;


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS delivered_via TEXT[];


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();


-- Source: supabase/migrations/20260520_results_checker_schema.sql
ALTER TABLE public.results_checker_orders ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();


-- Source: supabase/migrations/20260528_developer_api.sql
ALTER TABLE public.api_keys ADD COLUMN IF NOT EXISTS id UUID        DEFAULT uuid_generate_v4();
...
-- Source: supabase/migrations/20260528_developer_api.sql
ALTER TABLE public.api_keys ADD COLUMN IF NOT EXISTS name TEXT DEFAULT 'My API Key';


-- Source: supabase/migrations/20260528_developer_api.sql
ALTER TABLE public.api_keys ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'pending'
                             CHECK (status IN ('pending', 'active', 'revoked'));


-- Source: supabase/migrations/20260528_developer_api.sql
ALTER TABLE public.api_keys ADD COLUMN IF NOT EXISTS rate_limits JSONB;
...
-- Source: supabase/migrations/20260528_developer_api.sql
ALTER TABLE public.api_logs ADD COLUMN IF NOT EXISTS id UUID        DEFAULT uuid_generate_v4();


-- Source: supabase/migrations/20260528_developer_api.sql
ALTER TABLE public.api_logs ADD COLUMN IF NOT EXISTS api_key_id UUID        REFERENCES public.api_keys(id) ON DELETE SET NULL;


-- Source: supabase/migrations/20260528_developer_api.sql
ALTER TABLE public.api_logs ADD COLUMN IF NOT EXISTS user_id UUID        REFERENCES public.users(id)    ON DELETE SET NULL;
...
-- Source: supabase/migrations/20260528_developer_api.sql
ALTER TABLE public.api_logs ADD COLUMN IF NOT EXISTS method TEXT;


-- Source: supabase/migrations/20260528_developer_api.sql
ALTER TABLE public.api_logs ADD COLUMN IF NOT EXISTS status_code INTEGER;
...
-- Source: supabase/schema.sql
ALTER TABLE public.users ADD COLUMN IF NOT EXISTS id UUID REFERENCES auth.users(id) ON DELETE CASCADE;
...
-- Source: supabase/schema.sql
ALTER TABLE public.users ADD COLUMN IF NOT EXISTS role TEXT DEFAULT 'customer' CHECK (role IN ('customer', 'agent', 'sub-admin', 'admin'));


-- Source: supabase/schema.sql
ALTER TABLE public.users ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'active' CHECK (status IN ('active', 'suspended', 'inactive'));


-- Source: supabase/schema.sql
ALTER TABLE public.users ADD COLUMN IF NOT EXISTS agent_expires_at TIMESTAMP WITH TIME ZONE;
...
-- Source: supabase/schema.sql
ALTER TABLE public.wallets ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
...
-- Source: supabase/schema.sql
ALTER TABLE public.wallets ADD COLUMN IF NOT EXISTS balance DECIMAL(12, 2) DEFAULT 0.00;


-- Source: supabase/schema.sql
ALTER TABLE public.wallets ADD COLUMN IF NOT EXISTS total_credited DECIMAL(12, 2) DEFAULT 0.00;


-- Source: supabase/schema.sql
ALTER TABLE public.wallets ADD COLUMN IF NOT EXISTS total_spent DECIMAL(12, 2) DEFAULT 0.00;
...
-- Source: supabase/schema.sql
ALTER TABLE public.wallet_transactions ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();
...
-- Source: supabase/schema.sql
ALTER TABLE public.wallet_transactions ADD COLUMN IF NOT EXISTS user_id UUID REFERENCES public.users(id) ON DELETE CASCADE;


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_transactions ADD COLUMN IF NOT EXISTS type TEXT CHECK (type IN ('credit', 'debit'));


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_transactions ADD COLUMN IF NOT EXISTS amount DECIMAL(12, 2);
...
-- Source: supabase/schema.sql
ALTER TABLE public.wallet_transactions ADD COLUMN IF NOT EXISTS source TEXT CHECK (source IN ('payment', 'refund', 'admin', 'purchase'));


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_transactions ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'pending' CHECK (status IN ('pending', 'completed', 'failed'));
...
-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS user_id UUID REFERENCES public.users(id) ON DELETE CASCADE;


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS wallet_id UUID REFERENCES public.wallets(id) ON DELETE CASCADE;


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS amount DECIMAL(12, 2);


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS fee DECIMAL(12, 2) DEFAULT 0.00;


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS total_amount DECIMAL(12, 2);


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS reference TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS provider TEXT DEFAULT 'paystack';


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'pending' CHECK (status IN ('pending', 'completed', 'failed'));


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS provider_reference TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS metadata JSONB;


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.wallet_payments ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.data_packages ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/schema.sql
ALTER TABLE public.data_packages ADD COLUMN IF NOT EXISTS network TEXT CHECK (network IN ('MTN', 'Telecel', 'AT-iShare', 'AT-BigTime'));


-- Source: supabase/schema.sql
ALTER TABLE public.data_packages ADD COLUMN IF NOT EXISTS size TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.data_packages ADD COLUMN IF NOT EXISTS price DECIMAL(12, 2);


-- Source: supabase/schema.sql
ALTER TABLE public.data_packages ADD COLUMN IF NOT EXISTS cost_price DECIMAL(12, 2) DEFAULT 0.00;


-- Source: supabase/schema.sql
ALTER TABLE public.data_packages ADD COLUMN IF NOT EXISTS is_available BOOLEAN DEFAULT true;


-- Source: supabase/schema.sql
ALTER TABLE public.data_packages ADD COLUMN IF NOT EXISTS sort_order INT DEFAULT 0;


-- Source: supabase/schema.sql
ALTER TABLE public.data_packages ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.data_packages ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();
...
-- Source: supabase/schema.sql
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS price DECIMAL(12, 2);


-- Source: supabase/schema.sql
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS cost_price DECIMAL(12, 2) DEFAULT 0.00;


-- Source: supabase/schema.sql
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS payment_status TEXT DEFAULT 'paid' CHECK (payment_status IN ('paid', 'refunded'));
...
-- Source: supabase/schema.sql
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS fulfillment_method TEXT DEFAULT 'auto' CHECK (fulfillment_method IN ('auto', 'manual', 'codecraft', 'datakazina', 'kingflexy'));


-- Source: supabase/schema.sql
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS codecraft_reference TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS dakazina_reference TEXT;
...
-- Source: supabase/schema.sql
ALTER TABLE public.notifications ADD COLUMN IF NOT EXISTS type TEXT CHECK (type IN ('order_update', 'complaint_resolved', 'payment_success', 'balance_updated', 'system'));
...
-- Source: supabase/schema.sql
ALTER TABLE public.complaints ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/schema.sql
ALTER TABLE public.complaints ADD COLUMN IF NOT EXISTS user_id UUID REFERENCES public.users(id) ON DELETE CASCADE;


-- Source: supabase/schema.sql
ALTER TABLE public.complaints ADD COLUMN IF NOT EXISTS order_id UUID REFERENCES public.orders(id) ON DELETE CASCADE;
...
-- Source: supabase/schema.sql
ALTER TABLE public.complaints ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'pending' CHECK (status IN ('pending', 'in_review', 'resolved', 'rejected'));


-- Source: supabase/schema.sql
ALTER TABLE public.complaints ADD COLUMN IF NOT EXISTS priority TEXT DEFAULT 'medium' CHECK (priority IN ('low', 'medium', 'high'));
...
-- Source: supabase/schema.sql
ALTER TABLE public.complaints ADD COLUMN IF NOT EXISTS evidence JSONB;
...
-- Source: supabase/schema.sql
ALTER TABLE public.mtn_fulfillment_tracking ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/schema.sql
ALTER TABLE public.mtn_fulfillment_tracking ADD COLUMN IF NOT EXISTS order_id UUID REFERENCES public.orders(id) ON DELETE CASCADE;


-- Source: supabase/schema.sql
ALTER TABLE public.mtn_fulfillment_tracking ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'pending' CHECK (status IN ('pending', 'processing', 'completed', 'failed'));


-- Source: supabase/schema.sql
ALTER TABLE public.mtn_fulfillment_tracking ADD COLUMN IF NOT EXISTS api_response JSONB;


-- Source: supabase/schema.sql
ALTER TABLE public.mtn_fulfillment_tracking ADD COLUMN IF NOT EXISTS retry_count INT DEFAULT 0;


-- Source: supabase/schema.sql
ALTER TABLE public.mtn_fulfillment_tracking ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.mtn_fulfillment_tracking ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.fulfillment_logs ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/schema.sql
ALTER TABLE public.fulfillment_logs ADD COLUMN IF NOT EXISTS order_id UUID REFERENCES public.orders(id) ON DELETE CASCADE;


-- Source: supabase/schema.sql
ALTER TABLE public.fulfillment_logs ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'pending' CHECK (status IN ('pending', 'processing', 'completed', 'failed'));


-- Source: supabase/schema.sql
ALTER TABLE public.fulfillment_logs ADD COLUMN IF NOT EXISTS api_response JSONB;


-- Source: supabase/schema.sql
ALTER TABLE public.fulfillment_logs ADD COLUMN IF NOT EXISTS codecraft_reference TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.fulfillment_logs ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.fulfillment_logs ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();
...
-- Source: supabase/schema.sql
ALTER TABLE public.admin_settings ADD COLUMN IF NOT EXISTS value JSONB;


-- Source: supabase/schema.sql
ALTER TABLE public.admin_settings ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.admin_settings ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.phone_blacklist ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/schema.sql
ALTER TABLE public.phone_blacklist ADD COLUMN IF NOT EXISTS phone_number TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.phone_blacklist ADD COLUMN IF NOT EXISTS reason TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.phone_blacklist ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS user_id UUID REFERENCES public.users(id) ON DELETE CASCADE;


-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS full_name TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS phone TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS ghana_card TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS location TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS region TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS occupation TEXT;
...
-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'pending' CHECK (status IN ('pending', 'processing', 'completed', 'cancelled'));


-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS notes TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.afa_orders ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.customer_purchases ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/schema.sql
ALTER TABLE public.customer_purchases ADD COLUMN IF NOT EXISTS user_id UUID REFERENCES public.users(id) ON DELETE CASCADE;


-- Source: supabase/schema.sql
ALTER TABLE public.customer_purchases ADD COLUMN IF NOT EXISTS customer_phone TEXT;


-- Source: supabase/schema.sql
ALTER TABLE public.customer_purchases ADD COLUMN IF NOT EXISTS total_purchases INT DEFAULT 0;


-- Source: supabase/schema.sql
ALTER TABLE public.customer_purchases ADD COLUMN IF NOT EXISTS total_spent DECIMAL(12, 2) DEFAULT 0.00;


-- Source: supabase/schema.sql
ALTER TABLE public.customer_purchases ADD COLUMN IF NOT EXISTS first_purchase_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.customer_purchases ADD COLUMN IF NOT EXISTS last_purchase_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/schema.sql
ALTER TABLE public.system_announcements ADD COLUMN IF NOT EXISTS id uuid default gen_random_uuid();


-- Source: supabase/schema.sql
ALTER TABLE public.system_announcements ADD COLUMN IF NOT EXISTS title text;


-- Source: supabase/schema.sql
ALTER TABLE public.system_announcements ADD COLUMN IF NOT EXISTS message text;


-- Source: supabase/schema.sql
ALTER TABLE public.system_announcements ADD COLUMN IF NOT EXISTS is_active boolean default true;


-- Source: supabase/schema.sql
ALTER TABLE public.system_announcements ADD COLUMN IF NOT EXISTS visible_on text default 'main_site' check (visible_on in ('main_site', 'storefronts', 'both'));


-- Source: supabase/schema.sql
ALTER TABLE public.system_announcements ADD COLUMN IF NOT EXISTS created_at timestamp with time zone default timezone('utc'::text, now());


-- Source: supabase/schema.sql
ALTER TABLE public.system_announcements ADD COLUMN IF NOT EXISTS updated_at timestamp with time zone default timezone('utc'::text, now());


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS owner_id UUID REFERENCES public.users(id) ON DELETE CASCADE;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS shop_name TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS shop_slug TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS description TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS owner_email TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS whatsapp_number TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS logo_url TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS brand_color TEXT DEFAULT '#2563eb';


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS brand_accent TEXT DEFAULT '#1e40af';


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS approval_note TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS approved_by UUID REFERENCES public.users(id);


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS approved_at TIMESTAMP WITH TIME ZONE;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS fulfillment_mode TEXT DEFAULT 'auto' CHECK (fulfillment_mode IN ('auto', 'manual'));


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS withdrawal_fee_percent DECIMAL(5,2);


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS withdrawal_fee_flat DECIMAL(12,2);


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS min_withdrawal_amount DECIMAL(12,2);


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT false;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_profiles ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_global_settings ADD COLUMN IF NOT EXISTS key TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_global_settings ADD COLUMN IF NOT EXISTS value JSONB;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_global_settings ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_pricing ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_pricing ADD COLUMN IF NOT EXISTS shop_id UUID REFERENCES public.shop_profiles(id) ON DELETE CASCADE;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_pricing ADD COLUMN IF NOT EXISTS package_id UUID REFERENCES public.data_packages(id) ON DELETE CASCADE;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_pricing ADD COLUMN IF NOT EXISTS selling_price DECIMAL(12, 2);


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallets ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallets ADD COLUMN IF NOT EXISTS owner_id UUID REFERENCES public.users(id) ON DELETE CASCADE;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallets ADD COLUMN IF NOT EXISTS balance DECIMAL(12, 2) DEFAULT 0.00;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallets ADD COLUMN IF NOT EXISTS total_earned DECIMAL(12, 2) DEFAULT 0.00;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallets ADD COLUMN IF NOT EXISTS total_withdrawn DECIMAL(12, 2) DEFAULT 0.00;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallets ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallets ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS shop_wallet_id UUID REFERENCES public.shop_wallets(id) ON DELETE CASCADE;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS shop_order_id UUID;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS type TEXT CHECK (type IN ('profit', 'withdrawal'));


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS amount DECIMAL(12, 2);


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS fee DECIMAL(12, 2) DEFAULT 0.00;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS net_amount DECIMAL(12, 2);


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS description TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS momo_number TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'completed' CHECK (status IN ('completed', 'pending', 'rejected'));


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS admin_note TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_wallet_transactions ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS id UUID DEFAULT uuid_generate_v4();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS shop_id UUID REFERENCES public.shop_profiles(id) ON DELETE CASCADE;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS package_id UUID REFERENCES public.data_packages(id);


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS guest_phone TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS network TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS package_size TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS selling_price DECIMAL(12, 2);


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS cost_price DECIMAL(12, 2);


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS profit DECIMAL(12, 2);


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS paystack_reference TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'pending' CHECK (status IN ('pending', 'processing', 'completed', 'failed', 'refunded'));


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS fulfillment_reference TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS dakazina_reference TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS error_message TEXT;


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/shop_schema.sql
ALTER TABLE public.shop_orders ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();


-- Source: supabase/shop_withdrawal_improvements.sql
ALTER TABLE public.shop_payment_details ADD COLUMN IF NOT EXISTS id UUID DEFAULT gen_random_uuid();


-- Source: supabase/shop_withdrawal_improvements.sql
ALTER TABLE public.shop_payment_details ADD COLUMN IF NOT EXISTS shop_owner_id UUID REFERENCES public.users(id) ON DELETE CASCADE;


-- Source: supabase/shop_withdrawal_improvements.sql
ALTER TABLE public.shop_payment_details ADD COLUMN IF NOT EXISTS account_name TEXT;


-- Source: supabase/shop_withdrawal_improvements.sql
ALTER TABLE public.shop_payment_details ADD COLUMN IF NOT EXISTS momo_number TEXT;


-- Source: supabase/shop_withdrawal_improvements.sql
ALTER TABLE public.shop_payment_details ADD COLUMN IF NOT EXISTS network TEXT CHECK (network IN ('MTN MoMo', 'Telecel Cash', 'AirtelTigo Money'));


-- Source: supabase/shop_withdrawal_improvements.sql
ALTER TABLE public.shop_payment_details ADD COLUMN IF NOT EXISTS is_default BOOLEAN DEFAULT FALSE;


-- Source: supabase/shop_withdrawal_improvements.sql
ALTER TABLE public.shop_payment_details ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();
...
-- Source: supabase/migration_fix_roles.sql
-- Skipped superseded constraint definition: users_role_check
...
-- Source: supabase/add_shop_name_to_orders.sql
-- CREATE INDEX IF NOT EXISTS for easier filtering
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_announcements' AND policyname = 'Public can read shop announcements') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_announcements' AND policyname = 'Shop owners can manage their own announcements') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_profiles' AND policyname = 'shop_profiles_public_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_pricing' AND policyname = 'shop_pricing_public_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'afa_orders' AND policyname = 'Admin full access to afa_orders') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'airtime_orders' AND policyname = 'Users can view own airtime orders') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'airtime_orders' AND policyname = 'Users can create airtime orders') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'airtime_orders' AND policyname = 'Admins can view all airtime orders') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'airtime_orders' AND policyname = 'Admins can update airtime orders') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'chat_conversations' AND policyname = 'Agents can view own conversations') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'chat_conversations' AND policyname = 'Admins can view all conversations') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'chat_conversations' AND policyname = 'Agents can create conversations') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'chat_messages' AND policyname = 'Users can view conversation messages') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'chat_messages' AND policyname = 'Users can insert messages') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'chat_messages' AND policyname = 'Users can update own message read status') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_profiles' AND policyname = 'Admins view all shops') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_profiles' AND policyname = 'Admins update all shops') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_wallets' AND policyname = 'Admins view all shop wallets') THEN
    EXECUTE $sql$
-- ============================================================
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_wallet_transactions' AND policyname = 'Admins view all shop transaction history') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_wallet_transactions' AND policyname = 'Admins update shop transactions') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'mtn_fulfillment_tracking' AND policyname = 'Admin full access to mtn fulfillment tracking') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'fulfillment_logs' AND policyname = 'Admin full access to fulfillment logs') THEN
    EXECUTE $sql$
-- Admins can do everything
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'admin_settings' AND policyname = 'Admin read access to admin settings') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'admin_settings' AND policyname = 'Admin modify access to admin settings') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'phone_blacklist' AND policyname = 'Admin full access to phone blacklist') THEN
    EXECUTE $sql$
-- Admins can do everything
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'phone_blacklist' AND policyname = 'Authenticated users can check blacklist') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_orders' AND policyname = 'shop_orders_public_read') THEN
    EXECUTE $sql$
...
-- Source: supabase/fix_shop_guest_rls.sql
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_orders' AND policyname = 'shop_orders_public_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_profiles' AND policyname = 'shop_profiles_owner_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_orders' AND policyname = 'shop_orders_owner_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_pricing' AND policyname = 'shop_pricing_admin_write') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_pricing' AND policyname = 'shop_pricing_owner_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'wallet_payments' AND policyname = 'Users can view own wallet payments') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'wallet_payments' AND policyname = 'Admins can view all wallet payments') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_wallets' AND policyname = 'Owners can update their own shop wallet') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_wallet_transactions' AND policyname = 'Owners can insert their own shop transactions') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_wallet_transactions' AND policyname = 'shop_wallet_transactions_owner_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_wallet_transactions' AND policyname = 'admin_all_shop_transactions') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'download_batches' AND policyname = 'Admins can manage download_batches') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'admin_profit_logs' AND policyname = 'Admins can view profit logs') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_pricing_logs' AND policyname = 'Admins can view shop pricing logs') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'storage' AND tablename = 'objects' AND policyname = 'Shop Banners Public Read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'storage' AND tablename = 'objects' AND policyname = 'Shop Banners Auth Insert') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'storage' AND tablename = 'objects' AND policyname = 'Shop Banners Auth Update') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'storage' AND tablename = 'objects' AND policyname = 'Shop Banners Auth Delete') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_orders' AND policyname = 'shop_orders_shop_owner_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_orders' AND policyname = 'shop_orders_admin_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'phone_blacklist' AND policyname = 'phone_blacklist_admin_only') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_global_settings' AND policyname = 'shop_global_settings_public_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_global_settings' AND policyname = 'shop_global_settings_admin_write') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'admin_settings' AND policyname = 'Anyone can read admin settings') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_types' AND policyname = 'rc_types_select_all') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_types' AND policyname = 'rc_types_write_admin') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_inventory' AND policyname = 'rc_inventory_admin_only') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_orders' AND policyname = 'rc_orders_user_select') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_orders' AND policyname = 'rc_orders_admin_all') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'wallet_transactions' AND policyname = 'Users can view own transactions') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'wallet_payments' AND policyname = 'Users can view own payments') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'orders' AND policyname = 'Users can create orders') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'complaints' AND policyname = 'Users can view own complaints') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'complaints' AND policyname = 'Users can create complaints') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'customer_purchases' AND policyname = 'Users can view own customer purchases') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'afa_orders' AND policyname = 'Users can view own AFA orders') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'afa_orders' AND policyname = 'Users can create AFA orders') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'system_announcements' AND policyname = 'Admin full access') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'pending_settlements' AND policyname = 'Admin only access') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_announcements' AND policyname = 'shop_announcements_owner_all') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_global_settings' AND policyname = 'shop_global_settings_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_types' AND policyname = 'rc_types_admin_insert') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_types' AND policyname = 'rc_types_admin_update') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_types' AND policyname = 'rc_types_admin_delete') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_inventory' AND policyname = 'rc_inventory_admin_select') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_inventory' AND policyname = 'rc_inventory_admin_insert') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_inventory' AND policyname = 'rc_inventory_admin_update') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_inventory' AND policyname = 'rc_inventory_admin_delete') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_orders' AND policyname = 'rc_orders_admin_insert') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'results_checker_orders' AND policyname = 'rc_orders_admin_update') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_profiles' AND policyname = 'shop_profiles_owner_all') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_pricing' AND policyname = 'shop_pricing_owner_all') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_wallets' AND policyname = 'shop_wallets_owner_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'data_packages' AND policyname = 'Anyone can view packages') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'system_announcements' AND policyname = 'Public read access') THEN
    EXECUTE $sql$
-- Policies
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_announcements' AND policyname = 'shop_announcements_public_read') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_payment_details' AND policyname = 'Owners can view their own payment details') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_payment_details' AND policyname = 'Owners can insert their own payment details') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_payment_details' AND policyname = 'Owners can update their own payment details') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_payment_details' AND policyname = 'Owners can delete their own payment details') THEN
    EXECUTE $sql$
...
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shop_payment_details' AND policyname = 'Admins can view all payment details') THEN
    EXECUTE $sql$
...
-- Source: supabase/check_agents.sql
...
-- Source: supabase/grant_shop_rpc_to_anon.sql

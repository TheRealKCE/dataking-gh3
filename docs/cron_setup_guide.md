# Cron Job Setup Guide for ARHMS Platform
...
- **URL:** `https://www.dataking.qzz.io/api/cron/verify-moolre-payments`
...
- **URL:** `https://www.dataking.qzz.io/api/cron/sync-codecraft-status`
...
- **URL:** `https://www.dataking.qzz.io/api/cron/sync-kingflexy-status`
- **Schedule:** Every 5 minutes
- **Crontab expression:** `*/5 * * * *`
...
- **URL:** `https://www.dataking.qzz.io/api/cron/auto-refulfill`
- **Schedule:** Every 5 minutes
- **Crontab expression:** `*/5 * * * *`
...
- **URL:** `https://www.dataking.qzz.io/api/cron/sync-moolre-withdrawals`
...
- **URL:** `https://www.dataking.qzz.io/api/cron/release-rc-reservations`
...
- **URL:** `https://www.dataking.qzz.io/api/cron/auto-complete`
...
- **URL:** `https://www.dataking.qzz.io/api/cron/agent-renewal-reminder`
...
- **URL:** `https://www.dataking.qzz.io/api/cron/auto-upgrade-dealers`
...
- **URL:** `https://www.dataking.qzz.io/api/cron/delete-old-complaints`
...
- **URL:** `https://www.dataking.qzz.io/api/cron/delete-old-notifications`
...
- **URL:** `https://www.dataking.qzz.io/api/cron/delete-old-orders`
...
3.  **URL:** Use the full URL listed for each job.
